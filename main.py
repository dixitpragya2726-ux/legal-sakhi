...
from legal_assistant import generate_answer, get_helplines, draft_complaint, get_evidence_checklist, get_nearby_centers
...
@app.get("/nearby-help")
def nearby_help_endpoint(city: str = ""):
    centers = get_nearby_centers(city)
